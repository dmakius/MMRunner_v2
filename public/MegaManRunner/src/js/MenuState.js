...
MMRunner.MenuState = {
  ...
  create: function(){
    ...
    this.subtitle = this.game.add.bitmapText(this.game.world.centerX, 350, "marioFont", "RUNNER" , 28);
    this.subtitle.anchor.setTo(0.5);
   	
    this.game.title = this.game.add.bitmapText(this.game.world.centerX, 450, "marioFont", "press spacebar to start" , 18);
